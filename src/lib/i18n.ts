...
const translations: Translations = {
  en: {
    ...
    "auth.suspendedMessage":
      "Your account has been suspended. You can browse but cannot post or interact.",
  ...
  es: {
    ...
    "home.subtitle":
      "Conecta con amigos y comunidades que comparten tus intereses",
    ...
    "auth.suspendedMessage":
      "Tu cuenta ha sido suspendida. Puedes navegar pero no puedes publicar o interactuar.",
  ...
  fr: {
    ...
    "home.subtitle":
      "Connectez-vous avec des amis et des communautés qui partagent vos intérêts",
    ...
    "auth.suspendedMessage":
      "Votre compte a été suspendu. Vous pouvez naviguer mais ne pouvez pas publier ou interagir.",
  ...
  de: {
    ...
    "home.subtitle":
      "Verbinden Sie sich mit Freunden und Gemeinschaften, die Ihre Interessen teilen",
    ...
    "auth.suspendedMessage":
      "Ihr Konto wurde gesperrt. Sie können browsen, aber nicht posten oder interagieren.",
