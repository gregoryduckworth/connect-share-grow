...
const AdminAnalyticsPage = () => {
  ...
  const communities = [
    { id: "comm-1", name: "Photography Enthusiasts", members: 128, posts: 342, comments: 1456 },
    { id: "comm-2", name: "Tech Talk", members: 256, posts: 789, comments: 2890 },
    { id: "comm-3", name: "Book Readers", members: 96, posts: 156, comments: 678 },
    { id: "comm-4", name: "Travel Adventures", members: 78, posts: 234, comments: 890 },
    { id: "comm-5", name: "Fitness & Health", members: 189, posts: 445, comments: 1234 },
  ];
    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center gap-2 text-sm">
        ...
        <Badge variant="outline">
          {selectedCommunity === "all" ? "All Communities" : selectedCommunityData?.name}
        </Badge>
      ...
      {selectedCommunity !== "all" && selectedCommunityData && (
        <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
          ...
          <AdminMetricsCard
            ...
            value={`${((selectedCommunityData.comments / selectedCommunityData.posts) * 100).toFixed(1)}%`}
