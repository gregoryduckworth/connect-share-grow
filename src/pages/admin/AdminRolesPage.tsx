...
const AdminRolesPage = () => {
                  ...
                  <div className="flex items-start justify-between">
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        ...
                        <p className="text-xs text-gray-400">Joined {formatDate(user.joinDate)}</p>
                      </div>
                    </div>
                  </div>
  ...
  return (
    <div className="p-4 md:p-6 space-y-6 bg-background min-h-screen" data-testid="admin-roles-page">
      <div>
        <h1 className="text-3xl font-bold text-social-primary mb-2" data-testid="admin-roles-title">
          Roles & Permissions
        </h1>
      ...
      <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3" data-testid="admin-roles-grid">
        {roles.map((role) => (
          <RoleCard key={role.name} role={role} data-testid={`admin-role-card-${role.name}`} />
        ))}
      </div>
    </div>
  );
